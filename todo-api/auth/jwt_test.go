...
import (
	...
	"github.com/techarm/todo-api/testutil"
	"github.com/techarm/todo-api/testutil/fixture"
)
...
func TestJWTer(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, `https://github.com/techarm`, nil)
...
func TestJWTer_GetJWT(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/techarm/go-react`).
